...
namespace LillysCatering.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNo,Order,Address,Date")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNo,Order,Address,Date")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
